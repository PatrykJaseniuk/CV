...
Statyczna, jednostronna aplikacja hostowana i budowana na GH (CI/CD) reklamująca siłownie. Wykorzystuje w niej hooki i efekty dla zapewnienia przyjemnego doświadczenia użytkownika. Aplikacja posiada takie elementy jak: rozwijany pasek górny w zależności od przewijania strony, czy możliwość wyboru motywu kolorystycznego, a od strony kodu: izolacja danych od komponentów, podział kodu na warstwy (Stratified Design), programowanie funkcyjne (immutability of data).
