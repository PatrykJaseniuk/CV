...
Dzień dobry, z przyjemnością aplikuję na stanowisko **Monter Automatyki** w Państwa firmie. 

Moje umiejętności i wykształcenie skupione są głównie wokół informatyki, programowania, w szczególności systemów internetowych. Z tego powodu w moim CV jest dużo elementów związanych z technologiami informatycznymi. Postanowiłem ich nie usuwać, ponieważ jestem przekonany że umiejętność programowania komputerów pomagają w rozwiązywaniu wszelkich problemów technicznych. Pozycje w CV, które uważam za najistotniejsze z punktu widzenia Państwa działalności oznaczyłem symbolem: 🎯 
...
Projekt ze studiów w ramach kursu 'Systemy Wbudowane'. Jest to ploter zbudowan z ramienia o dwóch przegubach obrotowych z równoległymi osiami obrotu. 
...
- Teoretyczne i praktyczna znajomość podstaw elektryczności
- Umiejętność obsługi popularnych narzędzi i elektronarzędzi np. wiertarki, szlifierki, suwmiarka itd.
- Umiejętność modyfikowania instalacji elektrycznych np. wymiana wyłącznika nadprądowego, instalacja oświetlenia,czy instalacja czujników ruch, albo zmierzchu.
- Projektowanie i instalacja systemów CCTV
...
## Doświadczenie 💼
![Serwis](https://img.shields.io/badge/-Serwis-%23007ACC.svg?style=for-the-badge&logo=wrench&logoColor=white)
![Produkcja](https://img.shields.io/badge/-Produkcja-%23ED8B00.svg?style=for-the-badge&logo=industry&logoColor=white)

- pracownik produkcji w firmie produkującej oświetlenie LED "Sowar" (2018)(Wrocław)
- pracownik serwisu rowerowego (2019)(Wrocław)
